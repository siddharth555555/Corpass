          ...
          <div 
            ...
            onClick={() => {
              ...
              if (typeof window !== 'undefined') {
                const role = window.location.pathname.includes('/dashboard/seller') ? 'seller' : 'buyer';
                
                if (notification.type === 'MESSAGE' && notification.entityType === 'INQUIRY' && notification.entityId) {
                  router.push(`/dashboard/${role}/messages?threadId=inquiry-${notification.entityId}`);
                } else if (notification.type === 'MESSAGE' && notification.entityType === 'ORDER' && notification.entityId) {
                  router.push(`/dashboard/${role}/messages?threadId=order-${notification.entityId}`);
                } else if (notification.entityType === 'ORDER' && notification.entityId) {
                  router.push(`/dashboard/${role}/orders?orderId=${notification.entityId}`);
                }
              }
            }}
          >
