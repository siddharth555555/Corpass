      ...
      <div className="flex-1 flex flex-col min-w-0 md:pl-0">
        <header className="h-[56px] flex items-center justify-between px-4 md:px-6 bg-transparent shrink-0 z-20">
          ...
          <div className="flex items-center gap-4 ml-auto">
            <Link href="/dashboard/buyer/profile" className="h-8 w-8 rounded-full bg-primary-50 border border-primary-100 flex items-center justify-center hover:bg-primary-100 transition-all duration-300">
